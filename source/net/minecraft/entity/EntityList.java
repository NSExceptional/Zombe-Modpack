...
public class EntityList
{
    ...
    //-ZMod-Ghost-----------------------------------------------
    public static String getEntityStringFromID(int entityID) {
        if (entityID < field_191311_g.size()) {
            return field_191311_g.get(entityID);
        }

        return null;
    }

    public static int getEntityIDFromString(String entity) {
        return field_191311_g.indexOf(entity);
    }
    //----------------------------------------------------------

...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void updateEntityActionState()
    {
        ...
        if (ZHandle.handle("shouldUpdatePlayerActionState", this.func_175160_A()))
        {
    ...
    public void onLivingUpdate()
    {
        ...
        //-ZMod-Fly-----------------------------------------------------------
        if (ZHandle.handle("allowVanillaSprint", true))
        //--------------------------------------------------------------------
        ...
        //-ZMod-Fly-----------------------------------------------------------
        if (ZHandle.handle("allowVanillaFly", true))
        //--------------------------------------------------------------------
        ...
        //-ZMod-Fly-----------------------------------------------------------
        if (!ZHandle.handle("isFlying", this, false))
        //--------------------------------------------------------------------
